...
get_corpus <- function(corpus = NULL,
  ...
  columns_short_order <-
    c(
      ...
      "yearWrittenStart", # "writtenYearStart",
      "yearWrittenFinish", # "writtenYearFinish",
      "yearPrintedStart", # "printYearStart",
      "yearPrintedFinish", # "printYearFinish",
      "yearPremieredStart", # "premiereYearStart",
      "yearPremieredFinish", # "premiereYearFinish",
      "wikidataId",
      "networkSize",
      "networkdataCsvUrl",
      "uri", # new
